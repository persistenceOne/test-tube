...
mod tests {
    ...
    fn test_query_error_no_route() {
        ...
        let res = app.query::<AdhocRandomQueryRequest, AdhocRandomQueryResponse>(
            "/persistencecore.random.v1beta1.Query/AdhocRandom",
        ...
        assert_eq!(
            err,
            QueryError {
                msg: "No route found for `/persistencecore.random.v1beta1.Query/AdhocRandom`".to_string()
            }
        );
    }
    ...
    fn test_query_error_failed_query() {
        ...
        let res = app.query::<PoolRequest, PoolResponse>(
            "/persistencecore.poolmanager.v1beta1.Query/Pool",
