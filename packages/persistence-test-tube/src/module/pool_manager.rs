    ...
    R: Runner<'a>,
{
    ...
    fn_query! {
        pub query_swap_exact_amount_in ["/persistencecore.poolmanager.v1beta1.Query/EstimateSwapExactAmountIn"]: EstimateSwapExactAmountInRequest => EstimateSwapExactAmountInResponse
    }

    // estimate single pool swap exact amount in
    fn_query! {
        pub query_single_pool_swap_exact_amount_in ["/persistencecore.poolmanager.v1beta1.Query/EstimateSinglePoolSwapExactAmountIn"]: EstimateSinglePoolSwapExactAmountInRequest => EstimateSwapExactAmountInResponse
    }

    // estimate swap exact amount out
    fn_query! {
        pub query_swap_exact_amount_out ["/persistencecore.poolmanager.v1beta1.Query/EstimateSwapExactAmountOut"]: EstimateSwapExactAmountOutRequest => EstimateSwapExactAmountOutResponse
    }

    // estimate single pool swap exact amount out
    fn_query! {
        pub query_single_pool_swap_exact_amount_out ["/persistencecore.poolmanager.v1beta1.Query/EstimateSinglePoolSwapExactAmountOut"]: EstimateSinglePoolSwapExactAmountOutRequest => EstimateSwapExactAmountOutResponse
    }

    // query num pools
    fn_query! {
        pub query_num_pools ["/persistencecore.poolmanager.v1beta1.Query/NumPools"]: NumPoolsRequest => NumPoolsResponse
    }

    // query all pools
    fn_query! {
        pub query_all_pools ["/persistencecore.poolmanager.v1beta1.Query/AllPools"]: AllPoolsRequest => AllPoolsResponse
    }

    // query pool
    fn_query! {
        pub query_pool ["/persistencecore.poolmanager.v1beta1.Query/Pool"]: PoolRequest => PoolResponse
    }

    // query spot price
    fn_query! {
        pub query_spot_price ["/persistencecore.poolmanager.v1beta1.Query/SpotPrice"]: SpotPriceRequest => SpotPriceResponse
    }

    // query total liquidity
    fn_query! {
        pub query_total_liquidity ["/persistencecore.poolmanager.v1beta1.Query/TotalPoolLiquidity"]: TotalPoolLiquidityRequest => TotalPoolLiquidityResponse
    }
}
