    ...
    R: Runner<'a>,
{
    ...
    // query pools
    fn_query! {
        pub query_pools ["/persistencecore.concentratedliquidity.v1beta1.Query/Pools"]: PoolsRequest => PoolsResponse
    }

    // query params
    fn_query! {
        pub query_params ["/persistencecore.concentratedliquidity.v1beta1.Query/Params"]: ParamsRequest => ParamsResponse
    }

    // query liquidity_net_in_direction
    fn_query! {
        pub query_liquidity_depths_for_range ["/persistencecore.concentratedliquidity.v1beta1.Query/LiquidityNetInDirection"]: LiquidityNetInDirectionRequest => LiquidityNetInDirectionResponse
    }

    // query user_positions
    fn_query! {
        pub query_user_positions ["/persistencecore.concentratedliquidity.v1beta1.Query/UserPositions"]: UserPositionsRequest => UserPositionsResponse
    }

    // query liquidity_net_in_direction
    fn_query! {
        pub query_liquidity_net_in_direction ["/persistencecore.concentratedliquidity.v1beta1.Query/LiquidityNetInDirection"]: LiquidityNetInDirectionRequest => LiquidityNetInDirectionResponse
    }

    // query liquidity_per_tick_range
    fn_query! {
        pub query_liquidity_per_tick_range ["/persistencecore.concentratedliquidity.v1beta1.Query/LiquidityPerTickRange"]: LiquidityPerTickRangeRequest => LiquidityPerTickRangeResponse
    }

    // query claimable_fees
    fn_query! {
        pub query_claimable_fees ["/persistencecore.concentratedliquidity.v1beta1.Query/ClaimableSpreadRewards"]: ClaimableSpreadRewardsRequest => ClaimableSpreadRewardsResponse
    }

    // query position_by_id
    fn_query! {
        pub query_position_by_id ["/persistencecore.concentratedliquidity.v1beta1.Query/PositionById"]: PositionByIdRequest => PositionByIdResponse
    }
}
