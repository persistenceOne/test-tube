    ...
    R: Runner<'a>,
{
    ...
    fn_query! {
        pub query_arithmetic_twap ["/persistencecore.twap.v1beta1.Query/ArithmeticTwap"]: v1beta1::ArithmeticTwapRequest => v1beta1::ArithmeticTwapResponse
    }
    fn_query! {
        pub query_arithmetic_twap_to_now ["/persistencecore.twap.v1beta1.Query/ArithmeticTwapToNow"]: v1beta1::ArithmeticTwapToNowRequest => v1beta1::ArithmeticTwapToNowResponse
    }

    fn_query! {
        pub query_geometric_twap ["/persistencecore.twap.v1beta1.Query/GeometricTwap"]: v1beta1::GeometricTwapRequest => v1beta1::GeometricTwapResponse
    }
    fn_query! {
        pub query_geometric_twap_to_now ["/persistencecore.twap.v1beta1.Query/GeometricTwapToNow"]: v1beta1::GeometricTwapToNowRequest => v1beta1::GeometricTwapToNowResponse
    }
}
